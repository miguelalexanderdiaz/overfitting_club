...
This tutorial builds on the DDPM framework [@ho2020denoising], the cosine
schedule and training improvements from [@nichol2021improved], the original
diffusion-based generative model [@sohl2015deep], the DDIM accelerated sampler
[@song2020denoising], the U-Net architecture [@ronneberger2015unet], and the
Diffusion Transformer [@peebles2023scalable] that motivates this series.
